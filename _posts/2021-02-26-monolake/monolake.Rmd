...
description: |
  Visualizing changing water levels in Mono Lake (1850-2017)
author:
...
ggplot(data = mono, aes(x = year, y = lake_level_feet_above_sea_level))+
  geom_line(size = 8, color = "dodgerblue4")+
  labs(x = "Time (years)",
  ...
  theme(plot.margin = unit(c(10,150,10,10), "lines"))+ #make room for annotations outside plot
  ...
  theme(axis.text = element_text(size = 70),
        axis.title = element_text(size = 80, face = "bold"))+ #increase text size, change font
